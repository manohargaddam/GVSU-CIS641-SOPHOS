...
import { THUMB_UP, THUMB_UP_OUTLINED } from '../../../../assets/icons';
...
export class BoardViewItemComponent implements OnChanges{
  ...
  constructor(
    ...
    iconRegistry.addSvgIconLiteral('thumb-up', sanitizer.bypassSecurityTrustHtml(THUMB_UP));
    iconRegistry.addSvgIconLiteral('thumb-up-outlined', sanitizer.bypassSecurityTrustHtml(THUMB_UP_OUTLINED));
  }
